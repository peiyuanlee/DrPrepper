  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container} edges={['left', 'right']}>
        <ImageBackground
          source={require('../assets/images/profile_creation_bg4.png')}
          resizeMode="stretch"
          style={styles.image}
        >
          ...
          <View style={styles.topContainer}>
            ...
            />
            <Text style={styles.qText}>Question 4/8</Text>
          </View>
          ...
          {/* Question Text */}
          <Text style={styles.quesText}>How many people are in your household?</Text>
          ...
          <TouchableOpacity style={styles.button}>
            <Text style={styles.buttonText}>
              <Link href="/profile5">1 (Just me!)</Link>
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button}>
            <Text style={styles.buttonText}>
              <Link href="/profile5">2-4</Link>
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button}>
            <Text style={styles.buttonText}>
              <Link href="/profile5">5+</Link>
            </Text>
          </TouchableOpacity>
        </ImageBackground>
      </SafeAreaView>
